...
public class HandleObservation {
    ...
    private static final Map<String, List<String>> observableMap = new HashMap<String,List<String>>() {{
        ...
        put("ParsedCommands", new LinkedList<String>(Arrays.asList("ParsedCommandsObserver"))); //need to change
        //put("Functions", new LinkedList<String>(Arrays.asList("ParsedCommandsObserver"))); //need to change
        //put("Variables", new LinkedList<String>(Arrays.asList("ParsedCommandsObserver"))); //need to change
